...
@Component({
  selector: 'app-payroll-setup-master',
  templateUrl: './payroll-setup-master.component.html',
  styleUrls: ['./payroll-setup-master.component.scss']
})
